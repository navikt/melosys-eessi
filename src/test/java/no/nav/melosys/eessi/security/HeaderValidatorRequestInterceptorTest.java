...
public class HeaderValidatorRequestInterceptorTest {
  ...
  public void preHandle_naisProfile_expectValidationSuccessful() throws Exception {
    HeaderValidatorRequestInterceptor requestInterceptor = new HeaderValidatorRequestInterceptor(HEADER_NAME, HEADER_VALUE, "nais");
    Boolean result;
  ...
  public void preHandle_lovalProfile_expectValidationUnauthorized() throws Exception {
    HeaderValidatorRequestInterceptor requestInterceptor = new HeaderValidatorRequestInterceptor(HEADER_NAME, HEADER_VALUE, "local");
    Boolean result;
