...
internal class MelosysEessiMeldingMapperA001 : NyttLovvalgEessiMeldingMapper<MedlemskapA001> {
    ...
    override fun hentLovvalgsland(medlemskap: MedlemskapA001): String? = medlemskap.forespurtmedlemskap!!.iterator().next()!!.landkode

    override fun hentLovvalgsbestemmelse(medlemskap: MedlemskapA001): String = ARTIKKEL_16_1 // Denne er alltid 16.1
    ...
    override fun hentMedlemskap(sed: SED): MedlemskapA001 = sed.medlemskap as MedlemskapA001
