...
public class Bosted {
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        if (!(o instanceof Bosted)) return false;
        final Bosted other = (Bosted) o;
    ...
    protected boolean canEqual(final java.lang.Object other) {
        return other instanceof Bosted;
    }
    ...
    public java.lang.String toString() {
        return "Bosted(land=" + this.getLand() + ")";
    }

    @java.lang.SuppressWarnings("all")
    public Bosted(final String land) {
        this.land = land;
    }
