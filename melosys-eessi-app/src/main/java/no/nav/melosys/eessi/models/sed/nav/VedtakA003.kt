...
public class VedtakA003 extends Vedtak {
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        if (!(o instanceof VedtakA003)) return false;
        final VedtakA003 other = (VedtakA003) o;
    ...
    protected boolean canEqual(final java.lang.Object other) {
        return other instanceof VedtakA003;
    }
    ...
    public java.lang.String toString() {
        return "VedtakA003(gjeldervarighetyrkesaktivitet=" + this.getGjeldervarighetyrkesaktivitet() + ", gjelderperiode=" + this.getGjelderperiode() + ", land=" + this.getLand() + ")";
    }
}
