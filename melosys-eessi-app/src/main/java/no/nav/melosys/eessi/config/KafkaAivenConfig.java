...
public class KafkaAivenConfig {
    ...
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(KafkaAivenConfig.class);
    ...
    private RecordFilterStrategy<String, OppgaveKafkaAivenRecord> recordFilterStrategyOppgaveHendelserListener() {
        return consumerRecord -> !(OPPGAVE_ENDRET.equals(consumerRecord.value().hendelse().hendelsestype()) && oppgaveEndretService.erIdentifiseringsOppgave(consumerRecord.value()));
    }
}
