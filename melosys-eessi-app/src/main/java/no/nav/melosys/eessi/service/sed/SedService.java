...
public class SedService {
    ...
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(SedService.class);
    private final EuxService euxService;
    private final SaksrelasjonService saksrelasjonService;
    private final Unleash unleash;

    @Autowired
    public SedService(EuxService euxService, SaksrelasjonService saksrelasjonService, Unleash unleash) {
        this.euxService = euxService;
        this.saksrelasjonService = saksrelasjonService;
        this.unleash = unleash;
    }

    public BucOgSedOpprettetDto opprettBucOgSed(SedDataDto sedDataDto, Collection<SedVedlegg> vedlegg, BucType bucType, boolean sendAutomatisk, boolean forsøkOppdaterEksisterende) throws ValidationException {
        ...
        OpprettBucOgSedResponse response = opprettEllerOppdaterBucOgSed(sed, vedlegg, bucType, gsakSaksnummer, sedDataDto.getMottakerIder(), forsøkOppdaterEksisterende);
        ...
        return BucOgSedOpprettetDto.builder().rinaSaksnummer(response.getRinaSaksnummer()).rinaUrl(euxService.hentRinaUrl(response.getRinaSaksnummer())).build();
    }

    private String tilUUIDMedBindestreker(String uuidString) {
        return UUID.fromString(uuidString.substring(0, 8) + "-" + uuidString.substring(8, 12) + "-" + uuidString.substring(12, 16) + "-" + uuidString.substring(16, 20) + "-" + uuidString.substring(20)).toString();
    }
    ...
    private OpprettBucOgSedResponse opprettEllerOppdaterBucOgSed(SED sed, Collection<SedVedlegg> vedlegg, BucType bucType, Long gsakSaksnummer, List<String> mottakerIder, boolean forsøkOppdaterEksisterende) {
