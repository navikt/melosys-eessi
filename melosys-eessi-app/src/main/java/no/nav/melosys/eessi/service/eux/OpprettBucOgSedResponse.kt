...
public class OpprettBucOgSedResponse {
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        if (!(o instanceof OpprettBucOgSedResponse)) return false;
        final OpprettBucOgSedResponse other = (OpprettBucOgSedResponse) o;
    ...
    protected boolean canEqual(final java.lang.Object other) {
        return other instanceof OpprettBucOgSedResponse;
    }
    ...
    public java.lang.String toString() {
        return "OpprettBucOgSedResponse(rinaSaksnummer=" + this.getRinaSaksnummer() + ", dokumentId=" + this.getDokumentId() + ")";
    }

    @java.lang.SuppressWarnings("all")
    public OpprettBucOgSedResponse(final String rinaSaksnummer, final String dokumentId) {
        this.rinaSaksnummer = rinaSaksnummer;
        this.dokumentId = dokumentId;
    }

    @java.lang.SuppressWarnings("all")
    public OpprettBucOgSedResponse() {
    }
}
