...
import no.nav.melosys.eessi.service.buc.LukkBucAsyncService;
...
public class BucController {
    ...
    private final LukkBucAsyncService lukkBucAsyncService;

    public BucController(@Qualifier("tokenContext") EuxService euxService,
                         SedService sedService,
                         LukkBucAsyncService lukkBucAsyncService) {
        this.euxService = euxService;
        this.sedService = sedService;
        this.lukkBucAsyncService = lukkBucAsyncService;
    }
    ...
    public void lukkBuc(@PathVariable("rinaSaksnummer") String rinaSaksnummer) {
        lukkBucAsyncService.forsøkLukkBUCAsync(rinaSaksnummer);
    }
}
