...
public class EuxConsumer implements RestConsumer {
    ...
    public BUC hentBUC(String rinaSaksnummer) {
        ...
        return exchange(BUC_PATH, HttpMethod.GET, new HttpEntity<>(defaultHeaders()), new ParameterizedTypeReference<>() {
        }, rinaSaksnummer);
    }

    public String opprettBUC(String bucType) {
        log.info("Oppretter buc, type: {}", bucType);
        return exchange("/buc?BuCType={bucType}", HttpMethod.POST, new HttpEntity<>(defaultHeaders()), new ParameterizedTypeReference<>() {
        }, bucType);
    }

    public void slettBUC(String rinaSaksnummer) {
        log.info("Sletter buc: {}", rinaSaksnummer);
        exchange(BUC_PATH, HttpMethod.DELETE, new HttpEntity<>(defaultHeaders()), new ParameterizedTypeReference<Void>() {
        }, rinaSaksnummer);
    }

    @Retryable(value = NotFoundException.class, backoff = @Backoff(delay = 2000, maxDelay = 4000, multiplier = 2), maxAttempts = 5)
    public void settMottakere(String rinaSaksnummer, Collection<String> mottakerIDer) {
        ...
        exchange("/buc/{rinaSaksnummer}/mottakere?mottakere={mottakere}", HttpMethod.PUT, new HttpEntity<>(defaultHeaders()), new ParameterizedTypeReference<Void>() {
    ...
    public String opprettSed(String rinaSaksnummer, SED sed) {
        ...
        return exchange("/buc/{rinaSaksnummer}/sed", HttpMethod.POST, new HttpEntity<>(sed, defaultHeaders()), new ParameterizedTypeReference<>() {
        }, rinaSaksnummer);
    }

    public SED hentSed(String rinaSaksnummer, String dokumentId) {
        log.info("Henter sed med id {}, fra sak {}", dokumentId, rinaSaksnummer);
        return exchange(SED_PATH, HttpMethod.GET, new HttpEntity<>(defaultHeaders()), new ParameterizedTypeReference<>() {
    ...
    public void oppdaterSed(String rinaSaksnummer, String dokumentId, SED sed) {
        ...
        exchange(SED_PATH, HttpMethod.PUT, new HttpEntity<>(sed, defaultHeaders()), new ParameterizedTypeReference<Void>() {
        }, rinaSaksnummer, dokumentId);
    }
    ...
    public byte[] hentSedPdf(String rinaSaksnummer, String dokumentId) {
        ...
        return exchange(SED_PATH_PDF, HttpMethod.GET, new HttpEntity<>(headers), new ParameterizedTypeReference<>() {
        }, rinaSaksnummer, dokumentId);
    }
    ...
    public void sendSed(String rinaSaksnummer, String dokumentId) {
        ...
        exchange(SED_PATH + "/send", HttpMethod.POST, new HttpEntity<>(defaultHeaders()), new ParameterizedTypeReference<Void>() {
        }, rinaSaksnummer, dokumentId);
    }
    ...
    public String leggTilVedlegg(String rinaSaksnummer, String dokumentId, String filtype, SedVedlegg vedlegg) {
        ...
        return exchange(VEDLEGG_PATH, HttpMethod.POST, new HttpEntity<>(body, headers), new ParameterizedTypeReference<>() {
        }, rinaSaksnummer, dokumentId);
    }
    ...
    public void setSakSensitiv(String rinaSaksnummer) {
        ...
        exchange(BUC_PATH + "/sensitivsak", HttpMethod.PUT, new HttpEntity<>(defaultHeaders()), new ParameterizedTypeReference<Void>() {
        }, rinaSaksnummer);
    }

    public Map<String, String> opprettBucOgSedMedVedlegg(String bucType, String mottakerId, String filType, SED sed, byte[] vedlegg) {
        log.info("Oppretter buc {}, med sed {}, med mottaker {} og legger til vedlegg. ", bucType, sed.getSedType(), mottakerId);
        HttpHeaders headers = new HttpHeaders();
        headers.setContentType(MediaType.MULTIPART_FORM_DATA);
        ...
        return exchange("/buc/sed/vedlegg?BuCType={bucType}&MottakerID={mottakerID}&FilType={filType}", HttpMethod.POST, new HttpEntity<>(multipartBody, headers), new ParameterizedTypeReference<>() {
    ...
    public List<Institusjon> hentInstitusjoner(String bucType, String landkode) {
        ...
        return exchange("/institusjoner?BuCType={bucType}&LandKode={landkode}", HttpMethod.GET, new HttpEntity<>(defaultHeaders()), new ParameterizedTypeReference<>() {
        }, bucType, landkode);
    }
    ...
    public List<BucInfo> finnRinaSaker(String bucType, String status) {
        ...
        return exchange("/rinasaker?buctype={buctype}&status={status}", HttpMethod.GET, new HttpEntity<>(defaultHeaders()), new ParameterizedTypeReference<>() {
        }, bucType, status);
    }

    public String hentRinaUrl(String rinaSaksnummer) {
        log.info("Søker etter rina-url mot Rina med saksnummer {}", rinaSaksnummer);
        return exchange(RINA_LENKE_PATH, HttpMethod.GET, new HttpEntity<>(defaultHeaders()), new ParameterizedTypeReference<>() {
        }, rinaSaksnummer);
    }
    ...
    public SedMedVedlegg hentSedMedVedlegg(String rinaSaksnummer, String dokumentId) {
        ...
        return exchange(SED_MED_VEDLEGG_PATH, HttpMethod.GET, new HttpEntity<>(defaultHeaders()), new ParameterizedTypeReference<>() {
        }, rinaSaksnummer, dokumentId);
    }
    ...
    public Collection<String> hentSedHandlinger(String rinaSaksnummer, String sedId) {
        ...
        return exchange(SED_HANDLINGER, HttpMethod.GET, new HttpEntity<>(defaultHeaders()), new ParameterizedTypeReference<>() {
