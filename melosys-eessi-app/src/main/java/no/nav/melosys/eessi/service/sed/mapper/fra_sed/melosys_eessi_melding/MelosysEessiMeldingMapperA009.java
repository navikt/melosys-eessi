...
class MelosysEessiMeldingMapperA009 implements NyttLovvalgEessiMeldingMapper<MedlemskapA009> {
    ...
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(MelosysEessiMeldingMapperA009.class);
    ...
    public Boolean sedErEndring(MedlemskapA009 medlemskap) {
        ...
        log.info("sedErEndring i A009 er {}, med erendringsvedtak: {} og eropprinneligvedtak: {}", erEndring, medlemskap.getVedtak().getErendringsvedtak(), medlemskap.getVedtak().getEropprinneligvedtak());
        return erEndring;
    }
