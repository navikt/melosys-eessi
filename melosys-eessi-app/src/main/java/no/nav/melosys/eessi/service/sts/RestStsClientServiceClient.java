...
public class RestStsClientServiceClient implements RestStsClient {
    ...
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(RestStsClientServiceClient.class);
    ...
    @Autowired
    public RestStsClientServiceClient(@Qualifier("restStsRestTemplate") RestTemplate restTemplate, BasicAuthClientRequestInterceptor basicAuthClientRequestInterceptor) {
    ...
    private String generateToken() {
        ...
        try {
            ResponseEntity<Map<String, Object>> response = restTemplate.exchange(createUriString(), HttpMethod.GET, new HttpEntity<>(defaultHeaders()), new ParameterizedTypeReference<Map<String, Object>>() {
            });
    ...
    private String createUriString() {
        return UriComponentsBuilder.fromPath("/token").queryParam("grant_type", "client_credentials").queryParam("scope", "openid").toUriString();
    }
}
