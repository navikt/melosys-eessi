...
public class Adresse {
    ...
    public Adresse(no.nav.melosys.eessi.models.sed.nav.Adresse adresse) {
        this(adresse.getBy(), adresse.getBygning(), adresse.getGate(), adresse.getLand(), adresse.getPostnummer(), adresse.getRegion(), adresse.getType());
    }
    ...
    @java.lang.SuppressWarnings("all")
    public Adresse(final String by, final String bygning, final String gate, final String land, final String postnummer, final String region, final String type) {
        this.by = by;
        this.bygning = bygning;
        this.gate = gate;
        this.land = land;
