...
public class RestStsClientServiceClientMock implements RestStsClient {
    ...
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(RestStsClientServiceClientMock.class);
    ...
    @Autowired
    public RestStsClientServiceClientMock(@Qualifier("restStsRestTemplate") RestTemplate restTemplate, BasicAuthClientRequestInterceptor basicAuthClientRequestInterceptor) {
    ...
    private String generateToken() {
        ...
        try {
            ResponseEntity<Map<String, Object>> response = restTemplate.exchange("/token", HttpMethod.POST, entity, new ParameterizedTypeReference<Map<String, Object>>() {
            });
