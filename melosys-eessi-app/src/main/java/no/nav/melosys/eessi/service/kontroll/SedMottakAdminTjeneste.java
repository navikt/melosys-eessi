...
public class SedMottakAdminTjeneste {
    ...
    private Collection<SedMottattHendelseDto> lagSedMottattHendelseDtoer(Collection<SedMottattHendelse> sedMottattHendelser) {
        return sedMottattHendelser.stream().map(this::lagSedMottattHendelseDto).collect(Collectors.toList());
    }

    private SedMottattHendelseDto lagSedMottattHendelseDto(SedMottattHendelse sedMottattHendelse) {
        return new SedMottattHendelseDto(sedMottattHendelse.getId(), sedMottattHendelse.getSedHendelse(), sedMottattHendelse.getJournalpostId(), sedMottattHendelse.isPublisertKafka(), sedMottattHendelse.getMottattDato(), sedMottattHendelse.getSistEndretDato());
    }
