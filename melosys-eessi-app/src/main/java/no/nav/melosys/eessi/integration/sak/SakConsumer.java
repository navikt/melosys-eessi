...
public class SakConsumer implements RestConsumer, UUIDGenerator {
    ...
    public Sak getSak(String arkivsakId) throws IntegrationException {
    ...
    private <T> T exchange(String uri, HttpMethod method, HttpEntity<?> entity, Class<T> clazz, Object... variabler) throws IntegrationException {
        try {
